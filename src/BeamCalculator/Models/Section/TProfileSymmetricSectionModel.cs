...
public class TProfileSymmetricSectionModel : CommonSectionModel
{
    private static readonly Dictionary<string, SectionDimensionData> tProfileSymmetricDimensions = new Dictionary<string, SectionDimensionData>()
    {
    ...
    public override SectionTypes Type => SectionTypes.TProfileSymmetric;
    public override List<Point> Points => new List<Point>()
    {
        new Point(-_dimWidth / 2, -_dimHeight / 2 + _dimFlangeHeight),
        new Point(-_dimWebWidth / 2, _dimHeight / 2 - (_dimHeight - _dimFlangeHeight)),
        new Point(-_dimWebWidth / 2, _dimHeight / 2),
        new Point(_dimWebWidth / 2, _dimHeight / 2),
        new Point(_dimWebWidth / 2, _dimHeight / 2 - (_dimHeight - _dimFlangeHeight)),
    ...
    public override List<Fragment> Fragments => new List<Fragment>()
    {
        ...
        new Fragment(
            new Point(-_dimWebWidth / 2, _dimHeight / 2),
            new Point(_dimWebWidth / 2, -_dimHeight / 2 + _dimFlangeHeight),
            new Point(-_dimWebWidth / 2, -_dimHeight / 2 + _dimFlangeHeight)),
        new Fragment(
            new Point(-_dimWebWidth / 2, _dimHeight / 2),
            new Point(_dimWebWidth / 2, _dimHeight / 2),
    ...
    public TProfileSymmetricSectionModel() : base(tProfileSymmetricDimensions)
    { }
